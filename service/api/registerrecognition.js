                    ...
                    var req = unirest.get("https://face.p.mashape.com/tags/save?api_key="+nconf.get('SmartDoor.Identification.ApiKey')+"&api_secret="+nconf.get('SmartDoor.Identification.ApiSecret')+"&uid="+entryid+'%40'+nconf.get("SmartDoor.Identification.NamespaceName")+"&tids="+tags)
                      ...
                      .end(function (resp2) {
                        ...
                        if(resp2.status && resp2.status != 'error'){
                            console.log('Making request ' + "https://face.p.mashape.com/faces/train?api_key="+nconf.get('SmartDoor.Identification.ApiKey')+"&api_secret="+nconf.get('SmartDoor.Identification.ApiSecret')+"&uids="+entryid+'@'+nconf.get("SmartDoor.Identification.NamespaceName"));
                            var trainReq = unirest.get("https://face.p.mashape.com/faces/train?api_key="+nconf.get('SmartDoor.Identification.ApiKey')+"&api_secret="+nconf.get('SmartDoor.Identification.ApiSecret')+"&uids="+entryid+'@'+nconf.get("SmartDoor.Identification.NamespaceName"))
                            .headers({
                                "Content-Type": 'application/json',
                                "X-Mashape-Authorization": nconf.get('SmartDoor.Identification.MashapeKey')
                            })
